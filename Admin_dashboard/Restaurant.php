  ...
  <section class="home-section">
    ...
    <nav>
      ...
      <div class="sidebar-button">
        ...
        <span class="dashboard">Restaurant</span>
      </div>
      <!--search bar-->
    ...
    <div class="home-content">
      ...
      <div class="feature-display">
        <div class="leading">
          <div class="title">Reastaurants</div>
          <div class="add-btn">
            <button><a href="Add_Restaurant.html">Ajouter</a></button>
          </div>
        </div>
        ...
        echo'
          ...
          <img src="image/' . $rows['image'] . '">
            <div class="feature-details">
              ...
              <h2 style=" top: 0; margin-bottom: 0;">'. $rows["NomRestaurant"] .'</h2>
              ...
              <div style="margin-bottom: 0;" class="voyage-time">
                ...
                <span class="text">'. $rows["Telephone"] .'</span>
              </div>
              <div class="voyage-time">
              <i class="bx bx"></i>
              <span class="text">'. $rows["Description"] .'</span>
            </div>
