  ...
  <section class="home-section">
    ...
    <nav>
      ...
      <div class="sidebar-button">
        ...
        <span class="dashboard">Hôtels</span>
      </div>
      <!--search bar-->
    ...
    <div class="home-content">
      ...
      <div class="feature-display">
        <div class="leading">
          <div class="title">Hôtels</div>
          <div class="add-btn">
            <button><a href="Add_Hotels.html">Ajouter</a></button>
          </div>
        </div>
        ...
        echo'
          ...
          <img src="image/' . $rows['image'] . '">
            <div class="feature-details">
              ...
              <h2 style=" top: 0; margin-bottom: 0;">'. $rows["NomHotel"] .' </h2>
