  ...
  <section class="home-section">
    ...
    <nav>
      ...
      <div class="sidebar-button">
        ...
        <span class="dashboard">Villes</span>
      </div>
      <!--search bar-->
    ...
    <div class="home-content">
      ...
      <div class="feature-display">
        <div class="leading">
          ...
          <div class="add-btn">
            <button><a href="Add_Ville.html">Ajouter</a></button>
          </div>
        </div>
        ...
        echo'
          ...
          <img src="image/' . $rows['image'] . '">
            <div class="feature-details">
                  <h2 style="top: 0; margin-bottom: 0;">'. $rows["nom_ville"] .'</h2>
                  <div style="margin-bottom: 3px;" class="voyage-time">
                    <i class="bx bx-map"></i>
                    <span class="text">' .$rows["nom_ville"] .'</span>
                  </div></br></br>
                  <div class="voyage-time">
                    <i class="bx bx-map-alt"></i>
                    <span class="text">230 km2</span>
                  </div></br>

                  <p>'. $rows["descreption"] .'</p>
                  <div class="rud-btn">
                    <div class="edit-btn">
